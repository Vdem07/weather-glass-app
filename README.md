...
- 🕒 Почасовой прогноз, 🌤️ и 📅 прогноз на 5 дней
- 🎞️ Анимированные погодные иконки (Lottie) и статичные иконки (Flaticon)
- 🌗 Светлая и тёмная темы
- 📦 Кэширование данных — работает офлайн
- ⚙️ Расширенные настройки:
  - Единицы температуры, ветра, давления, видимости
  - Частота автоматического обновления данных
  - Варианты отображения детальных карточек: 1×10, 2×5, 5×2
  - Динамические или статичные погодные иконки
- 🧾 Детали погоды:
  - Давление, влажность, ветер, рассвет/закат
  - Видимость, вероятность осадков, точка росы, УФ-индекс
- 🧩 Раздел **"Для жизни"** с рекомендациями по:
  - Аллергии
  - Условиям на дорогах
  - Рыбалке
  - Отдыху у воды
  - Саду и огороду
  - Бегу  
  Содержит текущие условия, рекомендации, прогноз на 5 дней и почасовой прогноз
- 🗺️ Интерактивная карта с погодными слоями:
  - Осадки, облачность, температура, ветер, давление
  - Улучшенные и точные легенды
